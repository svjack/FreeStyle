...
# 运行风格迁移
def run_style_transfer(image, prompt, num_images, sampler, step, cfg, height, width, seed, n, b, s, refiner, grid):
...
# Gradio 接口
def gradio_interface(image, prompt, num_images, sampler, step, cfg, height, width, seed, n, b, s, refiner, grid):
    generated_images = run_style_transfer(image, prompt, num_images, sampler, step, cfg, height, width, seed, n, b, s, refiner, grid)
